...
function fnasairl(asairl) {
  ...
  function showasairl() {
    ...
    <style>
      ...
      #asairltxq .asairltxqc td {
        height: 66px;
      }
      #asairltxq .asairltxqt td {
        height: 28px;
        font-size: large;
        color: #409eff;
        font-weight: bold;
      ...
      .asairltxqr:hover .asairldc,
      .asairltxql:hover .asairldc,
      .asairltxqz:hover .asairldc {
        display: none;
      }
      .asairltxqr:hover .asairldt,
      .asairltxql:hover .asairldt,
      .asairltxqz:hover .asairldt,
      .asairltxqr:hover .asairldj,
      .asairltxql:hover .asairldj,
      .asairltxqz:hover .asairldj,
      .asairltxqr:hover .asairlds,
      .asairltxql:hover .asairlds,
      .asairltxqz:hover .asairlds {
        position: absolute;
        left: 0;
        z-index: 999;
        width: 100%;
      ...
      .asairltxqz:hover .asairlds {
        ...
        box-shadow: 0px 12px 8px 0px #303133;
      }
      .asairlonk {
        font-size: small;
      }
